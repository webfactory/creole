...
class CreoleTest extends CreoleBaseTest {
    ...
    public function testParseDSN() {
        ...
        $this->checkDSN($dsninfo, array('phptype', 'username', 'password', 'hostspec', 'port'=> '110',
                                         'database' => '/usr/db_file.db', 'param1'=>'value1','param2'=>'value2',
                            ));

        $dsn = 'phptype:///path/to/dbfile.db';
        $this->checkDSN(Creole::parseDSN($dsn), array('phptype', 'database' => '/path/to/dbfile.db'));
        ...
        $this->checkDSN(Creole::parseDSN($dsn), array('phptype', 'hostspec', 'protocol', 'database'));
